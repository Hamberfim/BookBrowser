...
function loadBook(fileName, displayName) {
    ...
    // create http server request to load the book
    var xhr = new XMLHttpRequest();
    // initial connection - async request
    xhr.open("GET", url, true);
    xhr.send();

    // check if completed
    xhr.onreadystatechange = function () {
        // 0 == unsent, 1 == file is open, 2 == recieved header/info about request, 3 == loading the file to deliver, 4 == done
        ...
        if (xhr.readyState == 4 && xhr.status == 200) {
            ...
            // cleanup text to remove line breaks and carriage returns and replace with a <br>
